...
que un valor nulo se refiere a la ausencia de estos. 
...
\subsection{Alcance}
Se encuentra dentro del alcance del trabajo elaborar un \textit{dataset} con variables provenientes de presurometrías. El conjunto 
...
\begin{enumerate}
	...
	\item Requerimientos de documentación:
		\begin{enumerate}
			...
			En consecuencia, se deben incluir comentarios que permitan a cualquier persona comprender
...
En primer lugar, existen trabajos que buscan predecir MACE a partir de otras fuentes, como historias clínicas 
