...
\begin{figure}[b!]
  ...
  \caption{Representación esquemática del pulso de presión registrado en la aorta ascendente.}
  \label{fig:aorticPulse}
\end{figure}

Ennnn la figura \autoref{fig:aorticPulse} se expone un registro típico de las pulsaciones 
de la presión en la raíz de la arteria aorta.
...
la clasificación de HTA de la tabla 1 [2].


\subsection{Introducción a presiones arteriales. Que es la hipertensión. Figura de presiones durante el día-noche-24hs}
...
Escribir aca sobre la hipertensión
