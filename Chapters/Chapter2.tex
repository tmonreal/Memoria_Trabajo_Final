...
\begin{figure}[h!]
	...
	\subcaptionbox{Clasificador perfecto.\label{fig:ROC_a}}%
  	[0.3\linewidth]{\includegraphics[height=10cm]{./Figures/ROC_a.jpg}}
	\hspace{1em}
	\subcaptionbox{Clasificador con buen \\poder predictivo.\label{fig:ROC_b}}
	[0.3\linewidth]{\includegraphics[height=10cm]{./Figures/ROC_b.jpg}}
	\hspace{1em}
...
capas que poseen diferentes estructuras de conexión. Por ejemplo, las capas de abandono o \emph{dropout} introducen la omisión de 
